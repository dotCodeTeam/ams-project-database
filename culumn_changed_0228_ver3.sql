...
(
    ...
    EMP_ID    		VARCHAR(20) binary UNIQUE NOT NULL,
    EMP_PW    		VARCHAR(20) binary NOT NULL,
...
VALUES (NULL,'eunSung', '1234', '조은성','A2', 'J6', STR_TO_DATE('20230201','%Y%m%d'), '010-1234-1234', '은성@gamil.com', 'S0')
	  ,  (NULL, 'sooBin', '5678', '윤수빈','A2', 'J5', STR_TO_DATE('20230210','%Y%m%d'), '010-1234-5678', '수빈@gamil.com', 'S0')
	  ,  (NULL, 'youngSang', '1357', '고영상','A2', 'J3', STR_TO_DATE('20230215','%Y%m%d'), '010-1357-1357', '영상@gamil.com', 'S1')
      ,  (NULL, 'chanWool', '8520', '임찬울','A2', 'J2', STR_TO_DATE('20230217','%Y%m%d'), '010-8520-1234', '찬울@gamil.com', 'S1')
      ,  (NULL, 'jinHyun', '0258', '박진현','A2', 'J1', STR_TO_DATE('20230220','%Y%m%d'), '010-0258-1234', '진현@gamil.com', 'S1');
...
INSERT INTO VACANT
VALUES (NULL,1,'C2',STR_TO_DATE('20230225','%Y%m%d'),STR_TO_DATE('20230301','%Y%m%d'),'자체휴가', NULL,NULL);
